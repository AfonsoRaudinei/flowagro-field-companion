-- Primeiro, vamos obter um user_id padrão ou criar um fictício para demonstração
-- Para fins de demonstração, vamos usar um UUID fixo que você pode substituir pelo seu user_id real
DO $$
DECLARE
...
BEGIN
    ...
    SELECT 
      ...
      CASE 
        ...
        WHEN p.name = 'Roberto Lima' THEN 'location'
        ELSE 'text'
      END,
      CASE 
